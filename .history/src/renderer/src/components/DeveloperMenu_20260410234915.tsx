            ...
            <div>
              ...
              {modpacks.length === 0 ? (
                ...
                <select value={filesMpId}
                  onChange={(e) => { setFilesMpId(e.target.value); setCurrentPath(''); setFiles([]); if (e.target.value) loadFiles(e.target.value) }}
            ...
            {filesMpId && (
              <>
                ...
                <div className="flex flex-col rounded-xl border border-white/5 overflow-hidden" style={{ minHeight: 240 }}>
                  <div className="grid grid-cols-[1fr_100px_76px_36px] bg-[#1a1a2e] border-b border-white/8">
                    ...
                    {filesLoading ? (
                      ...
                      <>
                        ...
                        {filesHere.map((f) => {
                          ...
                          return (
                            <div key={f.path} className="grid grid-cols-[1fr_100px_76px_36px] items-center border-b border-white/4 hover:bg-white/4 transition-colors">
