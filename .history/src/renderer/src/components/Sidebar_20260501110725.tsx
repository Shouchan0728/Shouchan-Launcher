...
import { Home, Monitor, Settings, Wrench, User, type LucideIcon } from 'lucide-react'
...
const navItems: { icon: LucideIcon; view: ViewType; label: string }[] = [
  { icon: Home, view: 'home', label: 'ホーム' },
  { icon: User, view: 'account', label: 'マイページ' },
