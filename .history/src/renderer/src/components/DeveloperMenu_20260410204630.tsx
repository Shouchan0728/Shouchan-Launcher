                  ...
                  <div key={mp.id}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        {mp.forgeVersion && <><span className="text-[10px] text-gray-600">·</span><span className="text-[10px] text-gray-500">Forge {mp.forgeVersion}</span></>}
              ...
              <div className="rounded-xl bg-[#1a1a2e] border border-yellow-500/20 p-4">
                ...
                <div className="flex flex-col gap-2.5">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      <label className="block text-[11px] text-gray-500 mb-1">Forgeバージョン</label>
                      <input type="text" value={newMpForm.forgeVersion} onChange={(e) => setNewMpForm({ ...newMpForm, forgeVersion: e.target.value })}
                        placeholder="47.2.0（任意）" className="w-full rounded-lg bg-[#0d0d14] border border-white/10 px-3 py-1.5 text-sm text-white placeholder-gray-600 outline-none focus:border-yellow-500/50 transition-colors" />
                    </div>
                  </div>
                  <div>
