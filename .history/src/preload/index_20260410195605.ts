...
const api = {
  ...
  setProfiles: (profiles: unknown) => ipcRenderer.invoke('set-profiles', profiles),
  devUploadModpackDir: (localDir: string, version: string) =>
    ipcRenderer.invoke('dev-upload-modpack-dir', localDir, version),
